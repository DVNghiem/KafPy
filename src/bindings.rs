...
/// - jitter_factor: 0.1
#[derive(Debug, Clone)]
#[pyclass(from_py_object, name = "RetryPolicy")]
...
/// - log_format: "pretty"
#[derive(Debug, Clone)]
#[pyclass(from_py_object, name = "ObservabilityConfig")]
...
#[pyclass(from_py_object, eq, eq_int, name = "FailureCategory")]
...
#[derive(Debug, Clone)]
#[pyclass(from_py_object, name = "FailureReason")]
